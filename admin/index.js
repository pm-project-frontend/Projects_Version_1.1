    ...
    document.getElementById("editDiv").innerHTML =
        `<div>
                <fieldset id="myFieldsetUser">
                    ...
                    Role:<br>
                    <input type="text" id="roleEdit" value="${user.role}"> <br>
                    Email:<br>
...
//         mainElem.innerHTML += `<p id=${elem.id}>${elem.organization} ${elem.status} ${elem.projectName} </p><br>`
//     }
// })
    ...
    document.getElementById("editDiv").innerHTML =
        `<div>
                <fieldset id="myFieldsetUser">
                    ...
                    <br>
                    <input type="radio" id="statusActive" name="statusEditProject" value="Open">
                    <label for="statusActive">Active</label>
                    <br>
                    <input type="radio" id="statusDisable" name="statusEditProject" value="Closed">
                    <label for="statusDisable">Suspended</label>
                    <br>
...
function delProject(reqId) {
    debugger;
    let pos = zResultProject.map(function (e) { return e.id; }).indexOf(reqId);
...
// let projectId = 2;
// function TextMK() {
//     pos = zResultProject.map(function (e) { return e.id; }).indexOf(reqId);
//     project = zResultProject[pos];
